...
import 'package:noteswidgetapp/features/shared_note/collab_editor/widgets/image_preview_overlay.dart';

class CollabImageBlock extends StatelessWidget {
  final DocumentBlock block;
  final SharedCollabEditorController controller;

  const CollabImageBlock({super.key, required this.block, required this.controller});
      ...
      PageRouteBuilder<void>(
        ...
        pageBuilder: (_, animation, __) {
          return FadeTransition(
            opacity: animation,
            child: CollabImagePreviewOverlay(
              path: path,
