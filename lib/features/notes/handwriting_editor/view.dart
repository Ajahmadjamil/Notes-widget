...
class HandwritingEditorScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: const _HandwritingEditorBody(),
    );
  }
}

class _HandwritingEditorBody extends StatefulWidget {
  const _HandwritingEditorBody();

  @override
  State<_HandwritingEditorBody> createState() => _HandwritingEditorBodyState();
}

class _HandwritingEditorBodyState extends State<_HandwritingEditorBody> {
