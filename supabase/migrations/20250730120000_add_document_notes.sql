-- Document notes: mixed text / image / audio blocks + private media bucket.

-- Allow note_type = document on personal notes
...
-- Shared notes: allow document type for future use
...
-- Private storage bucket for note media (free-tier friendly: 10 MB / file)
